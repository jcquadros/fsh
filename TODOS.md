...
- __BUGS__ : O que tá no código é uma porcaria e nao ta funcionando. Mas é a base pra fazer o restante.
...
- __(DONE Mas ainda falta tratar o caso de erro que a roberta fala)__ die: Terminar a shell e garantir que todos os descendentes vivos (não os processos secundários) também sejam terminados.
## Linguagem de Comandos
### Comandos e Argumentos: __(DONE)__
...
## Formato dos comandos: __(DONE)__
